...
module.exports.createReview=async(req,res)=>{  // 1.create form in show.ejs and send req to this route
...
module.exports.destroyReview=async(req,res)=>{ // 1.create form in show.ejs send req to this delete route
